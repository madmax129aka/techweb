  ...
  return (
    <div>
      ...
      <section className="section-cinematic min-h-[70vh]" id="overview">
        <div className="cinematic-scrim bg-gradient-to-br from-crimson/25 via-void to-arc/10" />
      ...
      <section className="max-w-5xl mx-auto px-6 py-24 grid sm:grid-cols-2 gap-12 items-center">
        <div className="aspect-[4/3] bg-gradient-to-br from-crimson/20 to-transparent order-2 sm:order-1" />
      ...
      <section id="rules" className="max-w-5xl mx-auto px-6 py-24 grid sm:grid-cols-2 gap-12 items-center border-t border-crimson/10">
        ...
        <div className="aspect-[4/3] bg-gradient-to-br from-arc/15 to-transparent" />
      </section>
        ...
        <section className="border-t border-crimson/10 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3">
            {otherEvents.map((e) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-crimson/30 via-crimson/5 to-transparent transition-transform duration-700 ease-out group-hover:scale-105" />
